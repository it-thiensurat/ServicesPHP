...
{ 
    ...
    public function index_post() {
        ...
        if ($this->getPay() == 1) {
            $sql = "SELECT TeamID, TeamCode, FnYear, FnNo, DepID, SupCheckTime, SupCheckNum, SupApproveNum, SupNotApproveNum, EmpID
                    FROM TSR_DB1.dbo.SaleTeam_Work100
    ...
    public function getWorkDetail($teamid) {
        $sql = "SELECT stwd.*, stwp.PaymentImage FROM TSR_DB1.dbo.SaleTeam_Work100_Detail stwd
                LEFT JOIN TSR_DB1.dbo.SaleTeam_Work100_Payment stwp ON stwd.DetailID = stwp.DetailID
