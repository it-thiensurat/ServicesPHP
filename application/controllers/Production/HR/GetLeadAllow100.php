...
{ 
    ...
    public function index_post() {
        ...
        $sql = "SELECT * FROM TSR_DB1.dbo.SaleTeam_Work100
    ...
    public function getWorkDetail($teamid) {
        $sql = "SELECT swd.DetailID, swd.TeamID, swd.EmpID, swd.EmpName, swd.SaleCode, swd.LeadCheckTime, swd.SupCheckTime, 
                ...
                FROM TSR_DB1.dbo.SaleTeam_Work100_Detail AS swd
    ...
    public function getPay() {
        $date = date('d-m-Y');
        $sql = "SELECT CONVERT(varchar, LockDate, 105), IsActive FROM TSR_Application.dbo.CostBranch_LockData_100 
    ...
    public function getApproveStatus($teamno, $depid, $fnno, $fnyear) {
        $sql = "SELECT SupApproveStatus FROM TSR_DB1.dbo.SaleTeam_Work100 WHERE TeamCode = ? AND DepID = ? AND FnNo = ? AND FnYear = ? 
